 ...
 * Read more about why we created this plugin at https://jackiedelia.com/genesis-awp-communities-plugin/
 *
 ...
 * Plugin URI:        https://github.com/jdelia/genesis-communities-cpt
 ...
 * GitHub Plugin URI: https://github.com/jdelia/genesis-communities-cpt
...
$plugin_version = '0.7.2'; // $plugin_data['Version'];

if ( ! defined( 'GENAWPCOMM_VERSION' ) ) { define( 'GENAWPCOMM_VERSION',  $plugin_version );
}
...
function genawpcomm_activation_check() {
	...
	if ( basename( get_template_directory() ) != 'genesis' ) {
		...
		// Deactivate ourself
		wp_die( sprintf( __( 'Whoa.. this plugin requires that you have installed the %1$sGenesis Framework version %2$s%3$s or greater.', GENAWPCOMM_DOMAIN ), '<a href="https://jackiedelia.com/go/genesis-framework-theme">', '</a>', $minimum_genesis_version ) );
	}
	...
	if ( version_compare( $version, $minimum_genesis_version, '<' ) ) {
		...
		// Deactivate ourself
		wp_die( sprintf( __( 'Oops.. you need to update to the latest version of the %1$sGenesis Framework version %2$s%3$s or greater to install this plugin.', GENAWPCOMM_DOMAIN ), '<a href="https://jackiedelia.com/go/genesis-framework-theme">', '</a>', $minimum_genesis_version ) );
	}
}
