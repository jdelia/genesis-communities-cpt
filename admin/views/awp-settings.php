		...
		<div id="post-body">
			<div id="post-body-content" class="has-sidebar-content">
				...
				<form action="options.php" method="post" id="awp-stylesheet-options-form">
					...
					<p><?php printf( __( 'If you change the slug, remember to', 'genesis-communities-cpt' ) );
					echo ' '; ?><a href="../wp-admin/options-permalink.php"><?php _e( 'save your permalinks settings again', 'genesis-communities-cpt' ); ?></a></p>
				...
				<br /><br />
				<p><?php printf( __( 'Your Community archive page is located at', 'genesis-communities-cpt' ) );
				echo ' '; ?>
				<a href="<?php echo site_url( '/' . $awp_options['slug'] );
				echo ' '; ?>"><?php echo site_url( '/' . sanitize_title( $awp_options['slug'] ) ); ?></a>
